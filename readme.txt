...
To run our website, you first need a program to run php for you (in our case we used XAMPP). After downloading XAMPP you start the php server, with all the website files in the htdocs folder. You then navigate to "localhost/recip-ez/index.php" to see the website.
